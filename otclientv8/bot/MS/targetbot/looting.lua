...
onTextMessage(function(mode, text)
  ...
  if string.find(text:lower(), "you cannot loot a corpse that you do not own") then -- if we are not the owners of corpse then its a waste of time to try to loot it
    table.remove(TargetBot.Looting.list, 1)
  end
end)
